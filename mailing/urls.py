...
urlpatterns = [
    ...
    path('users_detail/<int:pk>/', views.UsersDetailView.as_view(), name='users_detail'),
    path('users_detail/<int:pk>/switch/', views.UsersActiveSwitch.as_view(), name='active_switch'),
