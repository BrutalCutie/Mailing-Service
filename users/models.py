...
class MailingUser(AbstractUser):
    ...
    country = models.CharField(max_length=20, verbose_name='страна проживания', blank=True, null=True, default='Неизвестно')

    token = models.CharField(max_length=100, verbose_name='Токен для подтвержения почты', blank=True, null=True)
